...
class AuthProvider with ChangeNotifier {
  ...
  Future<bool> signOut() async {
    try {
      ...
      print('❌ Provider: Unexpected error during sign-out: $e');
  ...
  Future<bool> deleteAccount() async {
    try {
      ...
      print('🗑️ Provider: Deleting account...');
      ...
      print('❌ Provider: Unexpected error deleting account: $e');
